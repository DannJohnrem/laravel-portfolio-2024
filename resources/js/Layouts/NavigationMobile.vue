    ...
    <transition enter-active-class="transition duration-150 ease-in-out"
        ...
        <aside v-show="$page.props.showingMobileMenu"
            ...
            <div class="py-4 text-gray-500">
                <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('dashboard.index')">
                Windmill
                </Link>
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3" v-if="hasRole('Admin')">
                        ...
                        <transition name="fade">
                            <ul v-show="showingTwoLevelMenu"
                                ...
                                <li class="relative px-6 py-3">
                                    <ResponsiveNavLink :href="route('admin.index')" :active="isRouteActive(['admin.index', 'admin.create' , 'admin.edit'])" aria-current="page">
                                        <template #icon>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
