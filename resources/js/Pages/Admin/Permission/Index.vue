            ...
            <div class="w-full mb-8 overflow-hidden border rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="permission in permissions" :key="permission.id" class="text-gray-700">
                                ...
                                <TableDataCell class="inline-flex gap-2 align-middle">
                                    ...
                                    <button @click="confirmDelete(permission.id)" class="text-red-500 hover:text-red-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
...
const confirmDelete = (permId) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(route('permissions.destroy', permId), {
                method: 'DELETE',
                headers: {
