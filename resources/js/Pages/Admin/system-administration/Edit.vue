<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #link>
            <Link :href="route('admin.index')" aria-current="page"
        ...
        <div class="p-4 mb-20 bg-white rounded shadow-sm dark:bg-gray-800">
...
console.log(form.permissions = props.user?.permissions);
